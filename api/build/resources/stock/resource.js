...
exports.StockResource = void 0;
require("reflect-metadata");
var inversify_1 = require("inversify");
var routing_controllers_1 = require("routing-controllers");
var StockResource = /** @class */ (function () {
    function StockResource() {
    }
    // GET /stocks/:symbol
    ...
    StockResource.prototype.getStockPriceForSymbol = function (symbol) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // get the ticket symbol price here
                // if the symbol is not found, throw a 404
                return [2 /*return*/, { symbol: "requested symboL: " + symbol, price: 0 }];
            });
        });
    };
    __decorate([
        routing_controllers_1.Ctx(),
        routing_controllers_1.Get("/:symbol"),
        __param(0, routing_controllers_1.Param("symbol"))
    ], StockResource.prototype, "getStockPriceForSymbol", null);
    StockResource = __decorate([
